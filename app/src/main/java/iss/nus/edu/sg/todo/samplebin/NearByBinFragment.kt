...
import iss.nus.edu.sg.todo.samplebin.databinding.FragmentNearByBinBinding
...
class NearByBinFragment : Fragment(R.layout.fragment_near_by_bin), OnMapReadyCallback{
    ...
    private fun setupRecyclerView() {
        ...
        adapter = NearByBinsAdapter(nearbyBins) { }
    ...
    private fun fetchNearbyBins(lat: Double, lng: Double) {
     ...
     //           val url = java.net.URL( "http://10.0.2.2:8081/api/bins/nearby?lat=$lat&lng=$lng&radius=3000")
                val url = java.net.URL(
                    "http://192.168.1.37:8081/api/bins/nearby?lat=$lat&lng=$lng&radius=3000"
                )
